...
html_template = """      <!-- Hero Banner -->
          ...
          <div class="grid lg:grid-cols-2 gap-16">
            ...
            <div data-aos="fade-right">
              ...
              <p class="text-lg text-slate-600 leading-relaxed mb-6">
                Whether you are planning a new Dynamics 365 CRM implementation, improving an existing system, replacing disconnected tools, automating manual processes, building dashboards, or exploring AI-assisted customer experiences, Boscosoft Technologies is ready to help.
              </p>
              ...
              <div class="glass-card rounded-[24px] p-8 border-none bg-gradient-to-br from-slate-50 to-white shadow-lg bg-slate-50">
                ...
                <div class="space-y-3 text-slate-600">
                  <p class="flex items-center gap-3"><i class="fa-solid fa-envelope text-violet-600"></i> info@Boscosoft tech.com</p>
      ...
      <section class="py-24 bg-gradient-to-br from-violet-900 to-slate-900 relative overflow-hidden text-center">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-8" data-aos="fade-up">
          ...
          <p class="text-xl text-violet-100 mb-10 max-w-2xl mx-auto">With Boscosoft as your Dynamics 365 partner, you can move from scattered processes to a connected, automated, and insight-driven Microsoft CRM platform.</p>
...
# Replace Title & Meta
html = re.sub(r'<title>.*?</title>', '<title>Contact Boscosoft Dynamics 365 Experts | Book a CRM Consultation</title>', html, flags=re.DOTALL)

if '<meta name="description"' not in html and '<meta\n      name="description"' not in html:
    html = html.replace('<title>', '<meta name="description" content="Contact Boscosoft Technologies to discuss Microsoft Dynamics 365 CRM implementation, customization, automation, Power BI reporting, Dataverse, Copilot Studio, integration, migration, training, and support."/>\n    <title>')
else:
    html = re.sub(r'<meta[^>]*name="description"[^>]*>', '<meta name="description" content="Contact Boscosoft Technologies to discuss Microsoft Dynamics 365 CRM implementation, customization, automation, Power BI reporting, Dataverse, Copilot Studio, integration, migration, training, and support."/>', html, flags=re.IGNORECASE)
