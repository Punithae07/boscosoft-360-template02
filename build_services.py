...
html_template = """      <!-- Hero Banner -->
      ...
      <section class="py-16 bg-white relative z-10 text-center">
        <div class="max-w-4xl mx-auto px-8" data-aos="fade-up">
          ...
          <p class="text-body-lg text-slate-600 mb-4">Boscosoft provides complete Dynamics 365 services designed to help organizations adopt Microsoft CRM successfully and continue improving it over time.</p>
      ...
      <section class="py-24 bg-gradient-to-br from-violet-900 to-slate-900 relative overflow-hidden text-center">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-8" data-aos="fade-up">
          ...
          <p class="text-xl text-violet-100 mb-10 max-w-2xl mx-auto">Whether you are starting from scratch, replacing a legacy CRM, automating workflows, improving reporting, or optimizing an existing Dynamics 365 environment, Boscosoft can help.</p>
...
services_data = [
    ...
    },
    {
        ...
        "desc": "No two businesses operate in exactly the same way. Boscosoft customizes and configures Dynamics 365 so it reflects your actual processes, data flows, approval rules, reporting needs, and team responsibilities. We focus on practical customization that improves usability without creating unnecessary complexity.",
    ...
    },
    {
        ...
        "desc": "Manual tasks slow teams down and create room for missed follow-ups, delayed approvals, and inconsistent customer experiences. Boscosoft helps businesses automate repetitive CRM and operational workflows using Dynamics 365 and Power Automate. We design automations that support real business processes while keeping users informed and in control.",
    ...
    },
    {
        ...
        "desc": "Microsoft Dataverse provides the data foundation for Dynamics 365 and Power Platform solutions. Boscosoft helps organizations design clean, scalable, and secure data structures that support reliable CRM operations, automation, reporting, and integrations. Good data architecture makes your CRM easier to manage, easier to report on, and easier to scale.",
    ...
    },
    {
        ...
        "desc": "Microsoft Copilot Studio helps organizations build AI-assisted agents and conversational experiences that can support users, answer common questions, guide service journeys, and connect with business workflows. Boscosoft helps businesses plan, design, build, and optimize Copilot Studio solutions that integrate with Dynamics 365 and the wider Microsoft ecosystem.",
...
if '<meta name="description"' not in html and '<meta\n      name="description"' not in html:
    html = html.replace('<title>', '<meta name="description" content="Explore Boscosoft Dynamics 365 services including CRM consulting, implementation, customization, Power Automate workflows, Dataverse architecture, Power BI dashboards, Copilot Studio, integration, migration, training, and support."/>\n    <title>')
else:
    html = re.sub(r'<meta[^>]*name="description"[^>]*>', '<meta name="description" content="Explore Boscosoft Dynamics 365 services including CRM consulting, implementation, customization, Power Automate workflows, Dataverse architecture, Power BI dashboards, Copilot Studio, integration, migration, training, and support."/>', html, flags=re.IGNORECASE)
